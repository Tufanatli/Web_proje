...
<body id="anasayfa1">
    ...
    <div class="admin">
        <div class="row">
            <div class="col adminIletisimTablo">
                <?php if ($_POST["name"] == "G211210065@sakarya.edu.tr" && $_POST["password"] == "G211210065") {
    ...
    <footer class="py-3 text-white   text-center clr">
        <p>Web-Teknolojileri-Projesi Melih Tufan Atlı </p>
        <p>
            <a href="https://github.com" class="Link"><i class="fab fa-github" id="icon1"></i>
                Github</a>
            <a href="https://www.instagram.com/_tufanatlii" class="Link"><i class="fa-brands fa-instagram" id="icon1"></i>İnstagram</a>
            <a href="https://www.linkedin.com/in" class="Link"><i class="fa-brands fa-linkedin" id="icon1"></i>Linkedin</a>
        </p>
    </footer>
